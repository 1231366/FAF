...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_SESSION['user_id'])) {
    try {
        ...
        $race_name = !empty($_POST['race_name']) ? $_POST['race_name'] : null;
        ...
        $query = "INSERT INTO user_profiles (user_id, weight, height, age, fitness_level, target_distance, race_date, race_name, target_pace, ref_dist, ref_pace, available_days, prep_cycle)
                  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        ...
        $stmt->bind_param($types,
            ...
            $race_date, $race_name, $t_pace, $r_dist, $r_pace, $days, $weeks
        );
